...
export type InserirFiscalizacaoServicoNaoAutorizadoSemProcessoSeiParams = {
...
export type InserirFiscalizacaoServicoNaoAutorizadoSemProcessoSeiResult = {
  CDBiGrama: string;
  CDTriGrama: string;
...
export async function inserirFiscalizacaoServicoNaoAutorizadoSemProcessoSei(params: InserirFiscalizacaoServicoNaoAutorizadoSemProcessoSeiParams, options?: SoapRequestOptions) {
  return callSoapAction<InserirFiscalizacaoServicoNaoAutorizadoSemProcessoSeiResult>('InserirFiscalizacaoServicoNaoAutorizadoSemProcessoSei', params, options);
}
