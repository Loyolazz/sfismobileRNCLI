...
export type ConsultarFiscalizacaoParams = {
  idFiscalizacao: number;
};

export type ConsultarFiscalizacaoResult = {
  CDBiGrama: string;
  CDTriGrama: string;
...
export async function consultarFiscalizacao(params: ConsultarFiscalizacaoParams, options?: SoapRequestOptions) {
  return callSoapAction<ConsultarFiscalizacaoResult>('ConsultarFiscalizacao', params, options);
}
