...
export async function consultarEmpresasAutorizadas(params: ConsultarEmpresasAutorizadasParams, options?: SoapRequestOptions) {
  return callSoapAction<ConsultarEmpresasAutorizadasResult>('ConsultarEmpresasAutorizadas', params, options);
}
