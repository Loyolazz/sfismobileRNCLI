...
export type InserirFiscalizacaoParams = {
  cnpjEmpresa: string;
...
export type InserirFiscalizacaoResult = {
  CDBiGrama: string;
  CDTriGrama: string;
...
export async function inserirFiscalizacao(params: InserirFiscalizacaoParams, options?: SoapRequestOptions) {
  return callSoapAction<InserirFiscalizacaoResult>('InserirFiscalizacao', params, options);
}
