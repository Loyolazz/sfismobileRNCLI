...
export type InserirFiscalizacaoServicoNaoAutorizadoParams = {
...
export type InserirFiscalizacaoServicoNaoAutorizadoResult = {
  CDBiGrama: string;
  CDTriGrama: string;
...
export async function inserirFiscalizacaoServicoNaoAutorizado(params: InserirFiscalizacaoServicoNaoAutorizadoParams, options?: SoapRequestOptions) {
  return callSoapAction<InserirFiscalizacaoServicoNaoAutorizadoResult>('InserirFiscalizacaoServicoNaoAutorizado', params, options);
}
