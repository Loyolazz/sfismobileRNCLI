            ...
            <View style={styles.drawerHeaderText}>
              ...
              {unidade ? (
                <View style={styles.unidadePill}>
                  <Icon name="home-work" size={16} color={theme.colors.primaryDark} />
              ...
              <View style={styles.drawerChipsRow}>
                {matricula ? (
                  <View style={styles.drawerChipSm}>
                    <Icon name="badge" size={13} color={theme.colors.primaryDark} />
                    <Text style={styles.drawerChipSmText}>{matricula}</Text>
                  </View>
                ) : null}
                {email ? (
                  <View style={styles.drawerChipSm}>
                    <Icon name="email" size={13} color={theme.colors.primaryDark} />
                ...
                {login && login !== email ? (
                  <View style={styles.drawerChipSm}>
                    <Icon name="account-circle" size={13} color={theme.colors.primaryDark} />
                    <Text style={styles.drawerChipSmText} numberOfLines={1} ellipsizeMode="tail">
                      {login}
                    </Text>
                  </View>
