...
const TABLE_DEFINITIONS: string[] = [
  ...
  `CREATE TABLE IF NOT EXISTS PRESTADORESSERVICOS (
  ...
  `CREATE TABLE IF NOT EXISTS PRESTADORESSINCRONIZAR (
    ID INTEGER PRIMARY KEY,
    CDMUNICIPIO TEXT,
    DSBAIRRO TEXT,
    DSENDERECO TEXT,
  ...
  `CREATE TABLE IF NOT EXISTS FISCALIZACAOSERVICONAOAUTORIZADO (
    ...
    NORAZAOSOCIAL TEXT,
    ASSUNTO TEXT,
    IDTIPOINSTALACAOPORTUARIA TEXT,
  ...
  `CREATE TABLE IF NOT EXISTS TIPOTRANSPORTE (
    ID INTEGER PRIMARY KEY,
    IDTIPOTRANSPORTE INTEGER,
    DSTIPOTRANSPORTE TEXT
  )`,
  `CREATE TABLE IF NOT EXISTS TRECHOLINHA (
    ID INTEGER PRIMARY KEY,
    IDTRECHOLINHA INTEGER,
    DSTRECHOLINHA TEXT,
    IDTIPOTRANSPORTE1 TEXT,
    IDTIPOTRANSPORTE2 TEXT,
    IDTIPOTRANSPORTE3 TEXT,
    IDTIPOTRANSPORTE4 TEXT,
    IDTIPOTRANSPORTE5 TEXT,
    IDTIPOTRANSPORTE6 TEXT,
    IDTIPOTRANSPORTE7 TEXT
  )`,
  `CREATE TABLE IF NOT EXISTS TRECHOLINHATIPOTRANSPORTE (
    ID INTEGER PRIMARY KEY,
    INSTALACAO TEXT,
    MODALIDADE TEXT,
    IDTIPOTRANSPORTE TEXT,
    IDTRECHOLINHA TEXT,
    NRINSTRUMENTO TEXT,
    NRINSCRICAO TEXT
  )`,
  `CREATE TABLE IF NOT EXISTS EMBARCACOESINTERIOR (
    ID INTEGER PRIMARY KEY,
    TPINSCRICAO INTEGER,
    NRINSCRICAO TEXT,
    NRINSTRUMENTO TEXT,
  ...
  'CREATE INDEX IF NOT EXISTS IDX_PRESTADORES_DOC ON PRESTADORESSERVICOS(NRINSCRICAO, TPINSCRICAO)',
  'CREATE INDEX IF NOT EXISTS IDX_PRESTADORES_MUNICIPIO ON PRESTADORESSERVICOS(NOMUNICIPIO, SGUF)',
  'CREATE INDEX IF NOT EXISTS IDX_PRESTADORES_SYNC_DOC ON PRESTADORESSINCRONIZAR(NRINSCRICAO, TPINSCRICAO)',
  'CREATE INDEX IF NOT EXISTS IDX_TRECHOS_TIPO ON TRECHOLINHATIPOTRANSPORTE(IDTIPOTRANSPORTE)',
  'CREATE INDEX IF NOT EXISTS IDX_TRECHOS_LINHA ON TRECHOLINHATIPOTRANSPORTE(IDTRECHOLINHA)',
];
